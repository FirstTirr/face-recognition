    ...
    <footer className="bg-gray-900 text-gray-200 mt-24 pt-12 pb-6 px-4 md:px-24">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between gap-12 md:gap-0">
        ...
        <div className="flex flex-col gap-2 md:w-1/3">
          ...
          <a href="#tentang" className="hover:text-blue-400">
            Tentang
          </a>
          <a href="#fitur" className="hover:text-blue-400">
            Fitur
          </a>
          <a href="#cara-kerja" className="hover:text-blue-400">
            Cara Kerja
          </a>
          <a href="#akses" className="hover:text-blue-400">
            Akses
          </a>
        </div>
        <div className="flex flex-col gap-2 md:w-1/3">
